...
@Injectable()
export class SelectCustodyExtractionPhotoUseCase {
  constructor(
  ...
  async execute(id: string, photoId: string | null, user: AuthenticatedUser) {
    ...
    return this.custodyExtractionRepository.updateSelectedPhoto(id, photoId);
  }
}
