...
import { AuthenticatedUser, CustodyExtractedData } from '@portal-alvim/shared';
...
@Injectable()
export class UpdateCustodyExtractionUseCase {
  constructor(
  ...
  async execute(id: string, correctedData: CustodyExtractedData, user: AuthenticatedUser) {
    ...
    return this.custodyExtractionRepository.updateCorrections(id, correctedData);
  }
}
