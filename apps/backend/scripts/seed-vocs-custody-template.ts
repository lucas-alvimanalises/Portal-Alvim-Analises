// Script avulso: sobe/atualiza só o CustodyFieldTemplate de VOCs no banco
...
//   npx ts-node scripts/seed-vocs-custody-template.ts
// Mesma definição usada em prisma/seed.ts (VOCS_CUSTODY_TEMPLATE) — mantidas
...
async function main() {
  ...
  console.log('Template de VOCs salvo:', template.id);
}
