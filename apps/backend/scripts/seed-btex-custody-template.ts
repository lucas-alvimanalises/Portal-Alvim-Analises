// Script avulso: sobe/atualiza só o CustodyFieldTemplate de BTEX no banco já
...
//   npx ts-node scripts/seed-btex-custody-template.ts
// Mesma definição usada em prisma/seed.ts (BTEX_CUSTODY_TEMPLATE) — mantidas
...
async function main() {
  ...
  console.log('Template de BTEX salvo:', template.id);
}
