// Script avulso: sobe/atualiza só o CustodyFieldTemplate de Metais no banco
...
//   npx ts-node scripts/seed-metais-custody-template.ts
// Mesma definição usada em prisma/seed.ts (METAIS_CUSTODY_TEMPLATE) — mantidas
...
async function main() {
  ...
  console.log('Template de Metais salvo:', template.id);
}
