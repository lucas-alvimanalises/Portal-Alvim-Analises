// Script avulso: sobe/atualiza só o CustodyFieldTemplate de Particulados no
...
// com:
//   npx ts-node scripts/seed-particulados-custody-template.ts
// Mesma definição usada em prisma/seed.ts (PARTICULADOS_CUSTODY_TEMPLATE) —
...
async function main() {
  ...
  console.log('Template de Particulados salvo:', template.id);
}
