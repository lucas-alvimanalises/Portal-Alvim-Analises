// Script avulso: sobe/atualiza só o CustodyFieldTemplate de Amônia no banco
...
//   npx ts-node scripts/seed-amonia-custody-template.ts
// Mesma definição usada em prisma/seed.ts (AMONIA_CUSTODY_TEMPLATE) —
...
async function main() {
  ...
  console.log('Template de Amônia salvo:', template.id);
}
